...
public final class JavaGitConfiguration {
  ...
  public static String getGitCommand() {
    return getGitCommandPrefix() + "git" + getGitCommandSuffix();
  }
  
	/**
	 * Get git command suffix according system type:Windows,Unix-like
	 * @return
	 */
	public static String getGitCommandSuffix() {
		boolean isWindowsSystem = System.getProperty("os.name").contains(
				"Windows");
		String gitCommandSuffix = "";
		if (isWindowsSystem) {
			gitCommandSuffix = ".exe";
		}
		return gitCommandSuffix;
	}
